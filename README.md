...
```
🐸 Aura Frog v3.8.0-alpha.19 — Ready
...
Each worktree has its own state in `.claude/logs/runs/<id>/`. See [Git skill](aura-frog/skills/git/SKILL.md) (worktree isolation section).
