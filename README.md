...
[![Version](https://img.shields.io/badge/version-1.21.0-blue.svg)](aura-frog/CHANGELOG.md)
...
**v1.21.0:** Heavy skills (`framework-expert`, `seo-bundle`, `testing-patterns`, `learning-analyzer`) now run with `context: fork` to protect main context window.
