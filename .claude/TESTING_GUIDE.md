# 🧪 CCPM Workflow Testing Guide

**Date:** 2025-11-24  
**Purpose:** How to test the command-based CCPM workflow system
...
1. ✅ Detect command
2. ✅ Read `.claude/commands/workflow/start.md`
...
- [ ] Claude reads command files from `.claude/commands/workflow/`
...
### State Management ✅
- [ ] `.claude/workflow-state.json` created
...
Follow these steps:
1. Read .claude/commands/workflow/start.md
