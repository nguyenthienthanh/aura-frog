...
- **Component counts synced to disk across all docs.** Actual: 15 agents, 60 skills (9 auto + 51 reference), 72 rules (22 core + 20 agent + 30 workflow), 24 commands, 50 hooks. Corrected stale figures in `skills/README.md` (56→60; index was missing 8 skills — added a Planning & Safety section + `design-vision-loop`), `rules/README.md` (71→72; agent-rule index listed 19, missing `design-system-persistence` — row added), `aura-frog/CLAUDE.md` (40→51 reference skills; agent tier 19→20), `hooks/README.md` (28→50), root `README.md`, `docs/README.md`, `docs/reference/BENEFITS.md`, `CONTRIBUTING.md`.
