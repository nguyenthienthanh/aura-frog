...
**💡 Tip:** For React Native projects using NativeWind, generate components with Tailwind utility classes. See `skills/nativewind-component-generator.md` for templates.
