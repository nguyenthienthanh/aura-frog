...
```
.claude/
├── CLAUDE.md                    # ⚠️ CRITICAL: Agent banner + Aura Frog instructions
├── ccpm-config.yaml             # Project-specific workflow config
...
EOF
  echo "✅ Added Aura Frog section to .envrc"
else
  echo "✅ .envrc already has Aura Frog section"
fi
```
...
**⚠️ IMPORTANT:** This creates a PROJECT-SPECIFIC config in `.claude/ccpm-config.yaml`, NOT in the plugin directory.
...
echo "✅ Created .claude/ccpm-config.yaml"
```
...
```markdown
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
✅ Aura Frog Initialization Complete!
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
✅ .claude/ (project root) - Project-specific Aura Frog data folder
   ├── CLAUDE.md                    - Aura Frog instructions (agent banner, JIRA, etc.)
   ├── ccpm-config.yaml             - Project workflow config
   ├── settings.local.json          - Claude Code permissions (git-ignored)
   ├── project-contexts/
...
✅ Aura Frog is ready and project-aware!
```
...
📝 Setting up .envrc...
   ✅ Added Aura Frog integration section
...
**Project .envrc (root):**
```
.envrc (project root) → Project + Aura Frog env vars
