...
**Usage:** `cicd:create --platform github`, `cicd:create --platform gitlab`

---

## /deploy:docker-create

**Trigger:** `docker:create [options]`
...
**Usage:** `docker:create --compose --multi-stage`
