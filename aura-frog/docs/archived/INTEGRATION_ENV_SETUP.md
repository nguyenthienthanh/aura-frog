# Aura Frog Integration Setup Guide
...
Aura Frog supports integrations with:
...
2. Give it a label (e.g., "Aura Frog Integration")
...
- ✅ **Recommended:** Use Figma Bash script integration (see [BASH_INTEGRATIONS_GUIDE.md](BASH_INTEGRATIONS_GUIDE.md))
  - Aura Frog will automatically extract design data via `figma-fetch.sh` when you provide Figma links
  - No screenshots needed if Bash script is configured
- ⚠️ **Fallback:** If token not configured, provide screenshots instead
  - Aura Frog will analyze images visually
...
echo "🧪 Testing Aura Frog Integrations..."
echo ""
...
- `docs/BASH_INTEGRATIONS_GUIDE.md` (all 4 services)
