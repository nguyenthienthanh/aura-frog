...
### 1b. PreToolUse - Commit Attribution (NEW in 1.21.0)
...
### 3b. PreToolUse - Security-Critical Warnings (NEW in 1.21.0)
...
### 7b. PostToolUse - Security Scan (NEW in 1.21.0)
...
### 7c. PostToolUse - Auto Test Runner (NEW in 1.21.0)
...
### 7d. PostToolUse - Token Tracker (NEW in 1.21.0)
...
### 8b. UserPromptSubmit - Scope Drift Detection (NEW in 1.21.0)
...
### 10b. TeammateIdle - Idle Teammate Handler (NEW in 1.21.0)
...
### 10c. TaskCompleted - Task Completion Validator (NEW in 1.21.0)
...
### 11b. PreCompact - Pre-Compact State Save (NEW in 1.21.0)
